        ...
        {status === 'success' ? (
          <div className="rounded-md bg-green-50 p-4">
            <div className="flex">
              ...
              <div className="ml-3">
                <h3 className="text-sm font-medium text-green-800">Check your email (or terminal)</h3>
                ...
                <div className="mt-4">
                    <Link href="/auth" className="text-sm font-medium text-green-600 hover:text-green-500">
