...
// Displays a hero section for guests, quick category links, and a feed of the most recent donations.
...
export default function Home() {
  ...
  // --- Data Fetching ---
  // Fetch only the 4 most recent listings for the homepage feed
  useEffect(() => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* 1. HERO SECTION (Welcome for logged out users) */}
      {!session && (
        <div className="bg-indigo-600 text-white py-16 text-center">
          ...
          <div className="flex justify-center gap-4">
            <Link
              ...
              className="bg-white text-indigo-600 py-3 px-6 rounded-lg font-bold hover:bg-gray-100 transition"
            >
              Start Trading
            </Link>
            <Link
              href="/auth"
              className="border border-white text-white py-3 px-6 rounded-lg font-bold hover:bg-indigo-700 transition"
            >
              Sign In
            </Link>
          </div>
