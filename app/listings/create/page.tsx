...
export default function CreateListingPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto p-6 bg-white shadow-lg rounded-lg mt-10 mb-20">
      ...
      {error && (
        <div className="bg-red-50 text-red-500 p-3 rounded mb-6 text-sm font-medium">
          {error}
        </div>
      )}
            ...
            <div className="flex justify-between items-center mb-2">
              ...
              {parseFloat(formData.originalPrice) > 650 && (
                <span className="text-xs text-orange-600 font-bold bg-orange-100 px-2 py-1 rounded">
                  High Value Item: Add more photos!
                </span>
              )}
            </div>
            <ImageUpload
              value={formData.imageUrls}
              onUpload={handleItemImageAdd}
              onRemove={handleItemImageRemove}
            />
            <p className="text-xs text-gray-500 mt-2">
              {formData.imageUrls.length} / 4 required uploaded.
            </p>
          </div>
          <div>
            ...
            <ImageUpload
              value={formData.receiptUrl ? [formData.receiptUrl] : []}
              onUpload={handleReceiptAdd}
          ...
          <div className="flex gap-4">
            ...
            <div className="w-1/2">
              ...
              <input
                ...
                type="text"
                required
                placeholder="e.g. Victorian Desk"
                className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md"
