...
function ListingContent() {
  ...
  if (isLoading)
    return <p className="text-center p-10">Loading Listing Details...</p>;
  if (error)
    return <p className="text-center p-10 text-red-600">Error: {error}</p>;
  if (!listing)
    return <p className="text-center p-10">Listing Not Found (404)</p>;
          ...
          {showChat && chatRecipientId ? (
            <div>
              <button
                ...
                className="mb-2 text-sm text-gray-500 hover:text-indigo-600 flex items-center"
              >
            ...
            <>
              ...
              <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
                ...
                <p className="text-sm text-gray-700 mb-4">
                  <span className="font-medium">Location:</span> {listing.city}
                </p>
